 ...
 * 
 */
package com.android.hp.ros.rosbridge;

import com.android.hp.ros.ROSClient;
import com.android.hp.ros.Service;
import com.android.hp.ros.message.Message;
import com.android.hp.ros.message.MessageType;
import com.android.hp.ros.rosapi.message.Empty;
import com.android.hp.ros.rosapi.message.MessageDetails;
import com.android.hp.ros.rosapi.message.Nodes;
import com.android.hp.ros.rosapi.message.Services;
import com.android.hp.ros.rosapi.message.Topic;
import com.android.hp.ros.rosapi.message.Topics;
import com.android.hp.ros.rosapi.message.Type;
import com.android.hp.ros.rosapi.message.TypeDef;
import com.android.hp.ros.rosbridge.implementation.ROSBridgeWebSocketClient;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.android.hp.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.android.hp.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                        com.android.hp.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.android.hp.ros.rosapi.message.Service(service)).type;
    }
